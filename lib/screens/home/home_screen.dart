...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadStats() async {
    try {
      ...
      final lastScore =
          (lastWithScore['fluencyScore'] as num?)?.toInt() ?? 0;
  ...
  static const Color kHeaderBg  = Color(0xFF290451);
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 2),
                        const Text('Tap Progress to view history',
                            style: TextStyle(
                                fontSize: 12,
                                color: Color(0xFFC097D8))),
                      ],
